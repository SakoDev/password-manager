<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="pt-4 mt-4 border-t border-gray-500">
                <x-label for="pin_code" value="{{ __('Pin Code') }}" />
                <x-input id="pin_code" max='999999' class="block w-full mt-1" type="number" name="pin_code" required  />
            </div>
            <div class="p-1 mt-1">
                <p class="text-sm font-medium text-zinc-600"> Enter 6 numbers and you should remember it, if you lose it you can not get your data back</p>
            </div>
